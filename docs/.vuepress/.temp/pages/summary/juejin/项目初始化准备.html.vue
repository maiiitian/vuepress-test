...
<h3 id="使用ssh-config配置文件来管理ssh连接" tabindex="-1"><a class="header-anchor" href="#使用ssh-config配置文件来管理ssh连接" aria-hidden="true">#</a> 使用ssh config配置文件来管理ssh连接</h3>
<p>在电脑上.ssh文件夹中的config文件添加以下配置，没有就创建一个名为config的文件。</p>
...
<p>上传公钥到 gitlab</p>
<p><img src="img/拉取gitlab代码.assets/image-20230204160052848.png" alt="image-20230204160052848"></p>
<h3 id="克隆代码到本地" tabindex="-1"><a class="header-anchor" href="#克隆代码到本地" aria-hidden="true">#</a> 克隆代码到本地</h3>
<p><img src="img/拉取gitlab代码.assets/image-20230204160148757.png" alt="image-20230204160148757"></p>
...
<p>三种分支代表啥含义?</p>
<ul>
<li>prod分支: 基本没有问题的代码，是feat特性分支经过在dev上的多次测试后的没问题的代码。</li>
<li>dev分支:大家手.上各个feat特性分支在这里测试，都是从feat分支合入的。</li>
<li>feat分支:针对单独一个需求建立的，完成这个需求后被合入prod，结束。</li>
</ul>
<p>创建fate分支</p>
...
<p>运行<code v-pre>pnpm prepare</code>安装git hook，用于在commit时使用eslint校验、prettier格式化、commitlint校验提交信息，校验不通过则无法提交。</p>
<p>安装插件</p>
<p><img src="img/拉取gitlab代码.assets/image-20230204180441975.png" alt="image-20230204180441975"></p>
<hr>
<p>Expected linebreaks to be 'LF' but found 'CRLF'.</p>
<p>如果拉取代码后⾏尾红⾊波浪线报错，底下显⽰CRLF 是git设置的问题，需要执⾏</p>
<p><code v-pre>git config --global core.autocrlf false</code></p>
<p>重新拉取代码 应该显⽰的是</p>
<p><img src="img/项目初始化准备.assets/image-20230210023232951.png" alt="image-20230210023232951"></p>
